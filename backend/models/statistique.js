...
module.exports = class Statistique {
  constructor(annee,citations,articlesUdem,JR5COURANT,JR5RETRO) {
    this.annee = annee;
  ...
  static post(statistique) {
    ...
    /*let sql = "INSERT INTO tbl_statistiques SET annee =?,plateforme=?,Total_Item_Requests =?,Unique_Item_Requests =?,No_License =?,citations =?,articlesUdem =?,JR5COURANT =?,JR5INTER =?,JR5RETRO =?,idRevue = ?,dateA =? "
    console.log('sql: ', SqlString.format(sql,[statistique]));*/
    return db.execute('INSERT INTO tbl_statistiques SET annee =?,plateforme=?,Total_Item_Requests =?,Unique_Item_Requests =?,No_License =?,citations =?,articlesUdem =?,JR5COURANT =?,JR5INTER =?,JR5RETRO =?,idRevue = ?,dateA =? ', statistique );
  }
  ...
  static update( statistique) {
    ...
    let date = dt.format('Y-m-d H:M:S');
    //afficher la requette
    /*let sql = "UPDATE tbl_statistiques SET annee =?,plateforme=?,Total_Item_Requests =?,Unique_Item_Requests =?,No_License =?,citations =?,articlesUdem =?,JR5COURANT =?,JR5INTER =?,JR5RETRO =?,idRevue = ?,dateM =? WHERE idStatistique  = ?"
    ...
    return db.execute('UPDATE tbl_statistiques SET annee =?,plateforme=?,Total_Item_Requests =?,Unique_Item_Requests =?,No_License =?,citations =?,articlesUdem =?,JR5COURANT =?,JR5INTER =?,JR5RETRO =?,idRevue = ?,dateM =? WHERE idStatistique  = ?',
