...
@Component({
  selector: 'app-mise-a-jour-periodiques',
  templateUrl: './mise-a-jour-periodiques.component.html',
  styleUrls: ['./mise-a-jour-periodiques.component.css']
})
export class MiseAJourPeriodiquesComponent implements OnInit {

  //Initialiser le tableau d'annee'
  arrayAnnee:any[]=[];
  title = 'Mise a jour des periodiques';
  ...
  post( postLigne : any) {
    this.inUpdatePeriodiques$ = this.csvService
      .updateProcessousPeriodiques(postLigne)
