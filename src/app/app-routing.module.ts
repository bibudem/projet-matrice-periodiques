...
const routes: Routes = [
  ...
  { path: 'lot-periodiques', component: MiseEnLotPeriodiquesComponent, canActivate: [AuthGuard, AdminGuard] },
  { path: 'mise-a-jour-periodiques', component: MiseAJourPeriodiquesComponent, canActivate: [AuthGuard, AdminGuard] },
