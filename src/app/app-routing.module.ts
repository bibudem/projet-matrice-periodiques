...
const routes: Routes = [
  ...
  { path: 'periodique/add', component: PeriodiqueFormulaireComponent, canActivate: [AuthGuard] },
  { path: 'periodique/:id', component: PeriodiqueFormulaireComponent, canActivate: [AuthGuard] },
  { path: 'periodique/archive/:id', component: PeriodiqueArchiveComponent, canActivate: [AuthGuard] },
  { path: 'periodique/statistiques/:id', component: PeriodiqueStatistiquesComponent, canActivate: [AuthGuard] },
  { path: 'periodique/statistiques/:id/:return', component: PeriodiqueStatistiquesComponent, canActivate: [AuthGuard] },
  { path: 'periodique/historique/:id', component: PeriodiqueHistoriqueComponent, canActivate: [AuthGuard] },
  { path: 'periodique/note/:id', component: PeriodiqueNoteComponent, canActivate: [AuthGuard] },
  { path: 'periodique/prix/:id', component: PeriodiquePrixComponent, canActivate: [AuthGuard,] },
  { path: 'plateformes', component: ListePlateformesComponent, canActivate: [AuthGuard] },
  { path: 'plateforme-form', component: PlateformeFormComponent, canActivate: [AuthGuard] },
  { path: 'importation-sushi', component: ImportationSushiComponent, canActivate: [AuthGuard] },
  { path: 'mise-a-jour-periodiques', component: MiseEnLotPeriodiquesComponent, canActivate: [AuthGuard] },
  { path: 'importation-inCites', component: ImportationInCitesComponent, canActivate: [AuthGuard] },
  ...
  { path: 'logs-menu', component: LogsMenuComponent, canActivate: [AuthGuard] },
  { path: 'logs-revue', component: LogsRevueComponent, canActivate: [AuthGuard] },
  { path: 'logs-plateforme', component: LogsPlateformeComponent, canActivate: [AuthGuard] },
  { path: 'processus', component: ListeProcessusComponent, canActivate: [AuthGuard] },
  { path: 'processus/add', component: ListeProcessusComponent, canActivate: [AuthGuard] },
  { path: 'processus/details/:id', component: ListeProcessusDelailsComponent, canActivate: [AuthGuard] },
  { path: 'mise-a-jour-prix', component: MiseAJourPrixComponent, canActivate: [AuthGuard] },
  { path: 'mise-a-jour-archives', component: MiseAJourArchivesComponent, canActivate: [AuthGuard] },
  { path: 'mise-a-jour-statistiques', component: MiseAJourStatistiquesComponent, canActivate: [AuthGuard] },
  { path: 'mise-a-jour-abonnement', component: MiseAJourAbonnementComponent, canActivate: [AuthGuard] },
  { path: 'list-fonds', component: ListFondsComponent, canActivate: [AuthGuard] },
  { path: 'list-fournisseurs', component: ListFournisseursComponent, canActivate: [AuthGuard] },
